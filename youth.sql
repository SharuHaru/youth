...
--
-- Table structure for table `barangay_facebook_pages`
--
...
--
-- Dumping data for table `barangay_facebook_pages`
--
...
--
-- Table structure for table `facebook_page_tokens`
--
...
--
-- Indexes for table `barangay_facebook_pages`
--
ALTER TABLE `barangay_facebook_pages`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `facebook_page_tokens`
--
ALTER TABLE `facebook_page_tokens`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_authorized_account_id` (`authorized_account_id`),
  ADD KEY `fk_page_id` (`barangay_facebook_page_id`);
...
--
-- AUTO_INCREMENT for table `barangay_facebook_pages`
--
ALTER TABLE `barangay_facebook_pages`
...
--
-- Constraints for table `barangay_facebook_pages`
--
ALTER TABLE `barangay_facebook_pages`
  ADD CONSTRAINT `fk_barangay_id` FOREIGN KEY (`barangay_id`) REFERENCES `barangays` (`id`);
...
--
-- Constraints for table `facebook_page_tokens`
--
ALTER TABLE `facebook_page_tokens`
  ADD CONSTRAINT `fk_authorized_account_id` FOREIGN KEY (`authorized_account_id`) REFERENCES `authorized_accounts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_page_id` FOREIGN KEY (`barangay_facebook_page_id`) REFERENCES `barangay_facebook_pages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
